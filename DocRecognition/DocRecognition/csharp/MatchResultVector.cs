...
public class MatchResultVector : global::System.IDisposable, global::System.Collections.IEnumerable
    , global::System.Collections.Generic.IEnumerable<MatchResult>
 {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          csSmartIdEnginePINVOKE.delete_MatchResultVector(swigCPtr);
        }
  ...
  public void Clear() {
    csSmartIdEnginePINVOKE.MatchResultVector_Clear(swigCPtr);
  }

  public void Add(MatchResult x) {
    csSmartIdEnginePINVOKE.MatchResultVector_Add(swigCPtr, MatchResult.getCPtr(x));
    if (csSmartIdEnginePINVOKE.SWIGPendingException.Pending) throw csSmartIdEnginePINVOKE.SWIGPendingException.Retrieve();
  }

  private uint size() {
    uint ret = csSmartIdEnginePINVOKE.MatchResultVector_size(swigCPtr);
    return ret;
  }

  private uint capacity() {
    uint ret = csSmartIdEnginePINVOKE.MatchResultVector_capacity(swigCPtr);
    return ret;
  }

  private void reserve(uint n) {
    csSmartIdEnginePINVOKE.MatchResultVector_reserve(swigCPtr, n);
  }
  ...
  private MatchResult getitemcopy(int index) {
    MatchResult ret = new MatchResult(csSmartIdEnginePINVOKE.MatchResultVector_getitemcopy(swigCPtr, index), true);
    if (csSmartIdEnginePINVOKE.SWIGPendingException.Pending) throw csSmartIdEnginePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private MatchResult getitem(int index) {
    MatchResult ret = new MatchResult(csSmartIdEnginePINVOKE.MatchResultVector_getitem(swigCPtr, index), false);
    if (csSmartIdEnginePINVOKE.SWIGPendingException.Pending) throw csSmartIdEnginePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void setitem(int index, MatchResult val) {
    csSmartIdEnginePINVOKE.MatchResultVector_setitem(swigCPtr, index, MatchResult.getCPtr(val));
    if (csSmartIdEnginePINVOKE.SWIGPendingException.Pending) throw csSmartIdEnginePINVOKE.SWIGPendingException.Retrieve();
  }

  public void AddRange(MatchResultVector values) {
    csSmartIdEnginePINVOKE.MatchResultVector_AddRange(swigCPtr, MatchResultVector.getCPtr(values));
    if (csSmartIdEnginePINVOKE.SWIGPendingException.Pending) throw csSmartIdEnginePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void Insert(int index, MatchResult x) {
    csSmartIdEnginePINVOKE.MatchResultVector_Insert(swigCPtr, index, MatchResult.getCPtr(x));
    if (csSmartIdEnginePINVOKE.SWIGPendingException.Pending) throw csSmartIdEnginePINVOKE.SWIGPendingException.Retrieve();
  }

  public void InsertRange(int index, MatchResultVector values) {
    csSmartIdEnginePINVOKE.MatchResultVector_InsertRange(swigCPtr, index, MatchResultVector.getCPtr(values));
    if (csSmartIdEnginePINVOKE.SWIGPendingException.Pending) throw csSmartIdEnginePINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveAt(int index) {
    csSmartIdEnginePINVOKE.MatchResultVector_RemoveAt(swigCPtr, index);
    if (csSmartIdEnginePINVOKE.SWIGPendingException.Pending) throw csSmartIdEnginePINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveRange(int index, int count) {
    csSmartIdEnginePINVOKE.MatchResultVector_RemoveRange(swigCPtr, index, count);
    if (csSmartIdEnginePINVOKE.SWIGPendingException.Pending) throw csSmartIdEnginePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void Reverse() {
    csSmartIdEnginePINVOKE.MatchResultVector_Reverse__SWIG_0(swigCPtr);
  }

  public void Reverse(int index, int count) {
    csSmartIdEnginePINVOKE.MatchResultVector_Reverse__SWIG_1(swigCPtr, index, count);
    if (csSmartIdEnginePINVOKE.SWIGPendingException.Pending) throw csSmartIdEnginePINVOKE.SWIGPendingException.Retrieve();
  }
