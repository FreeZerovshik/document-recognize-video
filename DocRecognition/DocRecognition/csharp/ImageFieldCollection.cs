...
public class ImageFieldCollection : global::System.IDisposable 
    , global::System.Collections.Generic.IDictionary<string, ImageField>
 {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          csSmartIdEnginePINVOKE.delete_ImageFieldCollection(swigCPtr);
        }
  ...
  private uint size() {
    uint ret = csSmartIdEnginePINVOKE.ImageFieldCollection_size(swigCPtr);
    return ret;
  }

  public bool empty() {
    bool ret = csSmartIdEnginePINVOKE.ImageFieldCollection_empty(swigCPtr);
    return ret;
  }

  public void Clear() {
    csSmartIdEnginePINVOKE.ImageFieldCollection_Clear(swigCPtr);
  }

  private ImageField getitem(string key) {
    ImageField ret = new ImageField(csSmartIdEnginePINVOKE.ImageFieldCollection_getitem(swigCPtr, key), false);
    if (csSmartIdEnginePINVOKE.SWIGPendingException.Pending) throw csSmartIdEnginePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void setitem(string key, ImageField x) {
    csSmartIdEnginePINVOKE.ImageFieldCollection_setitem(swigCPtr, key, ImageField.getCPtr(x));
    if (csSmartIdEnginePINVOKE.SWIGPendingException.Pending) throw csSmartIdEnginePINVOKE.SWIGPendingException.Retrieve();
  }

  public bool ContainsKey(string key) {
    bool ret = csSmartIdEnginePINVOKE.ImageFieldCollection_ContainsKey(swigCPtr, key);
    if (csSmartIdEnginePINVOKE.SWIGPendingException.Pending) throw csSmartIdEnginePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void Add(string key, ImageField val) {
    csSmartIdEnginePINVOKE.ImageFieldCollection_Add(swigCPtr, key, ImageField.getCPtr(val));
    if (csSmartIdEnginePINVOKE.SWIGPendingException.Pending) throw csSmartIdEnginePINVOKE.SWIGPendingException.Retrieve();
  }

  public bool Remove(string key) {
    bool ret = csSmartIdEnginePINVOKE.ImageFieldCollection_Remove(swigCPtr, key);
    if (csSmartIdEnginePINVOKE.SWIGPendingException.Pending) throw csSmartIdEnginePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private global::System.IntPtr create_iterator_begin() {
    global::System.IntPtr ret = csSmartIdEnginePINVOKE.ImageFieldCollection_create_iterator_begin(swigCPtr);
    return ret;
  }

  private string get_next_key(global::System.IntPtr swigiterator) {
    string ret = csSmartIdEnginePINVOKE.ImageFieldCollection_get_next_key(swigCPtr, swigiterator);
    return ret;
  }

  private void destroy_iterator(global::System.IntPtr swigiterator) {
    csSmartIdEnginePINVOKE.ImageFieldCollection_destroy_iterator(swigCPtr, swigiterator);
  }
