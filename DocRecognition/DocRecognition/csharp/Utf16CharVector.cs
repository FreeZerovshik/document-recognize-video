...
public class Utf16CharVector : global::System.IDisposable, global::System.Collections.IEnumerable
    , global::System.Collections.Generic.IList<ushort>
 {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          csSmartIdEnginePINVOKE.delete_Utf16CharVector(swigCPtr);
        }
  ...
  public void Clear() {
    csSmartIdEnginePINVOKE.Utf16CharVector_Clear(swigCPtr);
  }

  public void Add(ushort x) {
    csSmartIdEnginePINVOKE.Utf16CharVector_Add(swigCPtr, x);
  }

  private uint size() {
    uint ret = csSmartIdEnginePINVOKE.Utf16CharVector_size(swigCPtr);
    return ret;
  }

  private uint capacity() {
    uint ret = csSmartIdEnginePINVOKE.Utf16CharVector_capacity(swigCPtr);
    return ret;
  }

  private void reserve(uint n) {
    csSmartIdEnginePINVOKE.Utf16CharVector_reserve(swigCPtr, n);
  }
  ...
  private ushort getitemcopy(int index) {
    ushort ret = csSmartIdEnginePINVOKE.Utf16CharVector_getitemcopy(swigCPtr, index);
    if (csSmartIdEnginePINVOKE.SWIGPendingException.Pending) throw csSmartIdEnginePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private ushort getitem(int index) {
    ushort ret = csSmartIdEnginePINVOKE.Utf16CharVector_getitem(swigCPtr, index);
    if (csSmartIdEnginePINVOKE.SWIGPendingException.Pending) throw csSmartIdEnginePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void setitem(int index, ushort val) {
    csSmartIdEnginePINVOKE.Utf16CharVector_setitem(swigCPtr, index, val);
    if (csSmartIdEnginePINVOKE.SWIGPendingException.Pending) throw csSmartIdEnginePINVOKE.SWIGPendingException.Retrieve();
  }

  public void AddRange(Utf16CharVector values) {
    csSmartIdEnginePINVOKE.Utf16CharVector_AddRange(swigCPtr, Utf16CharVector.getCPtr(values));
    if (csSmartIdEnginePINVOKE.SWIGPendingException.Pending) throw csSmartIdEnginePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void Insert(int index, ushort x) {
    csSmartIdEnginePINVOKE.Utf16CharVector_Insert(swigCPtr, index, x);
    if (csSmartIdEnginePINVOKE.SWIGPendingException.Pending) throw csSmartIdEnginePINVOKE.SWIGPendingException.Retrieve();
  }

  public void InsertRange(int index, Utf16CharVector values) {
    csSmartIdEnginePINVOKE.Utf16CharVector_InsertRange(swigCPtr, index, Utf16CharVector.getCPtr(values));
    if (csSmartIdEnginePINVOKE.SWIGPendingException.Pending) throw csSmartIdEnginePINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveAt(int index) {
    csSmartIdEnginePINVOKE.Utf16CharVector_RemoveAt(swigCPtr, index);
    if (csSmartIdEnginePINVOKE.SWIGPendingException.Pending) throw csSmartIdEnginePINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveRange(int index, int count) {
    csSmartIdEnginePINVOKE.Utf16CharVector_RemoveRange(swigCPtr, index, count);
    if (csSmartIdEnginePINVOKE.SWIGPendingException.Pending) throw csSmartIdEnginePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void Reverse() {
    csSmartIdEnginePINVOKE.Utf16CharVector_Reverse__SWIG_0(swigCPtr);
  }

  public void Reverse(int index, int count) {
    csSmartIdEnginePINVOKE.Utf16CharVector_Reverse__SWIG_1(swigCPtr, index, count);
    if (csSmartIdEnginePINVOKE.SWIGPendingException.Pending) throw csSmartIdEnginePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public bool Contains(ushort value) {
    bool ret = csSmartIdEnginePINVOKE.Utf16CharVector_Contains(swigCPtr, value);
    return ret;
  }

  public int IndexOf(ushort value) {
    int ret = csSmartIdEnginePINVOKE.Utf16CharVector_IndexOf(swigCPtr, value);
    return ret;
  }

  public int LastIndexOf(ushort value) {
    int ret = csSmartIdEnginePINVOKE.Utf16CharVector_LastIndexOf(swigCPtr, value);
    return ret;
  }

  public bool Remove(ushort value) {
    bool ret = csSmartIdEnginePINVOKE.Utf16CharVector_Remove(swigCPtr, value);
    return ret;
  }
