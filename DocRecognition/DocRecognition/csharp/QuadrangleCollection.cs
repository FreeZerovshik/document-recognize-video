...
public class QuadrangleCollection : global::System.IDisposable 
    , global::System.Collections.Generic.IDictionary<string, Quadrangle>
 {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef getCPtr(QuadrangleCollection obj) {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          csSmartIdEnginePINVOKE.delete_QuadrangleCollection(swigCPtr);
        }
  ...
  public QuadrangleCollection(QuadrangleCollection other) : this(csSmartIdEnginePINVOKE.new_QuadrangleCollection__SWIG_1(QuadrangleCollection.getCPtr(other)), true) {
    if (csSmartIdEnginePINVOKE.SWIGPendingException.Pending) throw csSmartIdEnginePINVOKE.SWIGPendingException.Retrieve();
  }

  private uint size() {
    uint ret = csSmartIdEnginePINVOKE.QuadrangleCollection_size(swigCPtr);
    return ret;
  }

  public bool empty() {
    bool ret = csSmartIdEnginePINVOKE.QuadrangleCollection_empty(swigCPtr);
    return ret;
  }

  public void Clear() {
    csSmartIdEnginePINVOKE.QuadrangleCollection_Clear(swigCPtr);
  }

  private Quadrangle getitem(string key) {
    Quadrangle ret = new Quadrangle(csSmartIdEnginePINVOKE.QuadrangleCollection_getitem(swigCPtr, key), false);
    if (csSmartIdEnginePINVOKE.SWIGPendingException.Pending) throw csSmartIdEnginePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void setitem(string key, Quadrangle x) {
    csSmartIdEnginePINVOKE.QuadrangleCollection_setitem(swigCPtr, key, Quadrangle.getCPtr(x));
    if (csSmartIdEnginePINVOKE.SWIGPendingException.Pending) throw csSmartIdEnginePINVOKE.SWIGPendingException.Retrieve();
  }

  public bool ContainsKey(string key) {
    bool ret = csSmartIdEnginePINVOKE.QuadrangleCollection_ContainsKey(swigCPtr, key);
    if (csSmartIdEnginePINVOKE.SWIGPendingException.Pending) throw csSmartIdEnginePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void Add(string key, Quadrangle val) {
    csSmartIdEnginePINVOKE.QuadrangleCollection_Add(swigCPtr, key, Quadrangle.getCPtr(val));
    if (csSmartIdEnginePINVOKE.SWIGPendingException.Pending) throw csSmartIdEnginePINVOKE.SWIGPendingException.Retrieve();
  }

  public bool Remove(string key) {
    bool ret = csSmartIdEnginePINVOKE.QuadrangleCollection_Remove(swigCPtr, key);
    if (csSmartIdEnginePINVOKE.SWIGPendingException.Pending) throw csSmartIdEnginePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private global::System.IntPtr create_iterator_begin() {
    global::System.IntPtr ret = csSmartIdEnginePINVOKE.QuadrangleCollection_create_iterator_begin(swigCPtr);
    return ret;
  }

  private string get_next_key(global::System.IntPtr swigiterator) {
    string ret = csSmartIdEnginePINVOKE.QuadrangleCollection_get_next_key(swigCPtr, swigiterator);
    return ret;
  }

  private void destroy_iterator(global::System.IntPtr swigiterator) {
    csSmartIdEnginePINVOKE.QuadrangleCollection_destroy_iterator(swigCPtr, swigiterator);
  }
